...
public class MemberMyPageApiController {
    ...
    public Set<MemberProfileDto> findFollowers(@AuthenticationPrincipal @PathVariable("memberId") final Long id) {
        return followService.findFollowers(id);
    }

    @Operation(summary = "팔로잉 조회")
    @GetMapping("/{memberId}/mypage/followings")
    public Set<MemberProfileDto> findFollowings(@AuthenticationPrincipal @PathVariable("memberId") final Long id) {
        return followService.findFollowings(id);
    }

    @Operation(summary = "팔로워 끊기")
    @DeleteMapping("/{memberId}/mypage/followers")
    public Long deleteFollow(@AuthenticationPrincipal @PathVariable("memberId") final Long id) {
